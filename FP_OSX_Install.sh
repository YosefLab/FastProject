...
curl "https://repo.continuum.io/miniconda/Miniconda2-latest-MacOSX-x86_64.sh" -o Miniconda_Install.sh
if [ $? -ne 0 ]; then
    curl "http://repo.continuum.io/miniconda/Miniconda2-latest-MacOSX-x86_64.sh" -o Miniconda_Install.sh
fi
set -e
